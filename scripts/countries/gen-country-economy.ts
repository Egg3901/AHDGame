...
${sectorEntries}
  ...
  payoutCapPerTurn: ${v("PLAYER_PAYOUT_CAP_PER_TURN")},
  sovereignCorpLegalStructure: ${v("SOVEREIGN_CORP_LEGAL_STRUCTURE")} as LegalStructureId,
  m2ToGdp1953: ${v("M2_TO_GDP_1953")},
};
