  ...
  return (
    <div className="rounded-xl border border-card-border bg-card overflow-hidden">
      <div className="border-b border-card-border bg-background/60 px-6 py-4">
        <h2 className="text-lg font-bold text-foreground">Share Buyback &amp; Escrow</h2>
        <p className="text-xs text-muted mt-0.5">
          How share sells settle. Instant buyback pays sellers from the treasury (blocked if it
          can&apos;t cover). Escrow runs a market-making desk: buys fund it, sells draw it down, and
          it may run a deficit (a tracked debt that lowers the share price).
        </p>
      </div>
      ...
      <div className="px-6 py-4 space-y-4">
        ...
        <p className="text-[10px] text-muted leading-relaxed">
          ...
          balance (a buyback debt) is covered from the corporation&apos;s assets first — if the debt
          is larger than what the corp has, the shortfall is borne by shareholders (there is no
          clawback from players who already sold into the escrow).
        </p>
