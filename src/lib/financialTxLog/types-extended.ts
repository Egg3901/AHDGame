...
export const TX_TYPE_LABELS: Record<FinancialTxType, string> = {
  ...
  dividend_reinvest: "Index Fund Dividend Reinvested",
  fund_transfer: "Index Fund Cross Transfer",
  index_fund_dividend: "Index Fund Dividend",
  npp_investment_income: "NPP Investment Income",
  ...
  corp_tech_unlock: "Technology Unlock",
