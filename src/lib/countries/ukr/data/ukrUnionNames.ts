...
/**
 * UKR's trade-union names, by era.
 *
...
export const UKR_UNION_NAMES_MODERN: Partial<Record<CorporationType, string>> = uniform(
  "Federation of Trade Unions of Ukraine"
);

export const UKR_UNION_NAMES_1979: Partial<Record<CorporationType, string>> = uniform(
