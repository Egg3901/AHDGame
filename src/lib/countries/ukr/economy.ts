 ...
 * Regenerate with:
 *
 *     npx tsx scripts/countries/gen-country-economy.ts UKR --force
 *
 ...
 *
 * ⚠ NO MONETARY BASELINE FOR 1971, 1979, 1991: UKR has no entry in
...
const nationalPolicyStateId = "ukr_national";
const legislationScope = "ukr";
 ...
 */
export const UKR_GDP_DENOMINATION_1953 = "local";

export const UKR_ECONOMY: CountryEconomy = {
  currencyCode,
  ...
  gdpDenomination1953: UKR_GDP_DENOMINATION_1953,
};
