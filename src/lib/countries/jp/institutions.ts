...
const legislativeProcess: LegislativeProcess = {
  executive: {
    title: "The Emperor",
    canVeto: false,
...
const ordersOfBattle: OrderOfBattleEntry[] = [
  {
    branchId: "nsf",
...
const estatePortfolio: Record<string, string> = {
...
export const JP_INSTITUTIONS: CountryInstitutions = {
  config,
  legislativeProcess,
  regionalBillAssentOfficeKey: "governor",
  positions: {
