...
import { ensureESElections, ensureESSenateElections } from "@/lib/turn/perpetualElections";
 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Spain has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Spain anywhere;
...
export const ES_ELECTIONS: CountryElections = {
