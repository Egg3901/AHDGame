...
/**
 * BAL's trade-union names, by era.
 *
...
export const BAL_UNION_NAMES_MODERN: Partial<Record<CorporationType, string>> = uniform(
  "Baltic Trade Union Confederation"
);

export const BAL_UNION_NAMES_1979: Partial<Record<CorporationType, string>> = uniform(
