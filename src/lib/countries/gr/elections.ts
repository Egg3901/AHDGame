...
import { ensureGRElections } from "@/lib/turn/perpetualElections";
 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Greece has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Greece anywhere;
 ...
 */
const phases: CountryElectionPhaseEntry[] = [{ name: "grElections", fn: ensureGRElections }];

export const GR_ELECTIONS: CountryElections = {
