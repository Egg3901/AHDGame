...
import { ensureTRElections, ensureTRSenateElections } from "@/lib/turn/perpetualElections";
 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Turkey has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Turkey anywhere;
...
export const TR_ELECTIONS: CountryElections = {
