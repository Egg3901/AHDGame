...
import { ensureBLRElections } from "@/lib/turn/perpetualElections";
 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Belarus has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Belarus anywhere;
...
const phases: CountryElectionPhaseEntry[] = [
  { name: "blrSupremeSovietElections", fn: ensureBLRElections },
];

export const BLR_ELECTIONS: CountryElections = {
