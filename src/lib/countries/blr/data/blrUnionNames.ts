...
/**
 * BLR's trade-union names, by era.
 *
...
export const BLR_UNION_NAMES_MODERN: Partial<Record<CorporationType, string>> = uniform(
  "Federation of Trade Unions of Belarus"
);

export const BLR_UNION_NAMES_1979: Partial<Record<CorporationType, string>> = uniform(
