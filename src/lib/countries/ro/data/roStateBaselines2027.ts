...
/** Romania region metric baselines (2027) — derived 1:1 from roStateMetrics2027. */
...
export const roStateBaselines2027: StateMetricBaseline[] = roStateMetrics2027.map(toBaseline);
export default roStateBaselines2027;
