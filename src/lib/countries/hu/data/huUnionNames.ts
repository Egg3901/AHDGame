...
export const HU_UNION_NAMES_MODERN: Partial<Record<CorporationType, string>> = uniform(
  "Hungarian Trade Union Confederation"
);

export const HU_UNION_NAMES_2007: Partial<Record<CorporationType, string>> = uniform(
  "National Confederation of Hungarian Trade Unions"
);

export const HU_UNION_NAMES_1979: Partial<Record<CorporationType, string>> = uniform(
