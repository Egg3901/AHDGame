...
import { ensureYUElections } from "@/lib/turn/perpetualElections";
 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Yugoslavia has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Yugoslavia anywhere;
...
const phases: CountryElectionPhaseEntry[] = [
  { name: "yuFederalAssemblyElections", fn: ensureYUElections },
];

export const YU_ELECTIONS: CountryElections = {
