 ...
 * Regenerate with:
 *
 *     npx tsx scripts/countries/gen-country-economy.ts BG --force
 *
 ...
 *
 * ⚠ NO MONETARY BASELINE FOR 1971, 1979, 1991: BG has no entry in
...
const currencyCode = "BGL" as CurrencyCode;
const nationalPolicyStateId = "bg_national";
const legislationScope = "bg";
 ...
 */
export const BG_GDP_DENOMINATION_1953 = "local";

export const BG_ECONOMY: CountryEconomy = {
  currencyCode,
  ...
  gdpDenomination1953: BG_GDP_DENOMINATION_1953,
};
