 ...
 * Regenerate with:
 *
 *     npx tsx scripts/countries/gen-country-economy.ts WAL --force
 *
 ...
 *
 * ⚠ NO MONETARY BASELINE FOR 1953, 1971, 1979, 1991: WAL has no entry in
...
const nationalPolicyStateId = "wal_national";
const legislationScope = "wls";
 ...
 */
/* No WAL_GDP_DENOMINATION_1953: the table lists only the countries the 1953
   world starts with, and WAL is not one of them. Later presets are uniformly
   local-currency by design, so there is nothing to denominate. */

export const WAL_ECONOMY: CountryEconomy = {
  currencyCode,
