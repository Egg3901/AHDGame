 ...
 *
 * ⚠️ NO `spawn`, AND NOTHING RELOCATED. Scotland has no row in
 ...
 *
 * ⚠️ NO `seats`. There is no seat table for Scotland anywhere;
...
export const SCO_ELECTIONS: CountryElections = {
