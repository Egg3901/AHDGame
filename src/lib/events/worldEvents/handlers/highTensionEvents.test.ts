  ...
  "worldEvents.panicBuying": {
    ...
    calm: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "agriculture", pct: 8, durationTurns: 4 },
        { type: "wireOnly" },
      ],
      [
  ...
  "worldEvents.bankRun": {
    guarantee: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "financial", pct: 3, durationTurns: 6 },
        { type: "wireOnly" },
      ],
    ],
    holiday: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "financial", pct: -8, durationTurns: 6 },
    ...
    standBy: [
      [
        { type: "approvalDelta", delta: -4 },
        { type: "sectorOutputDemandModifier", sectorType: "financial", pct: -10, durationTurns: 8 },
        { type: "wireOnly" },
      ],
      [
        { type: "sectorOutputDemandModifier", sectorType: "financial", pct: -3, durationTurns: 4 },
        { type: "wireOnly" },
      ],
    ],
  },
  "worldEvents.civilDefenseFever": {
    fund: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "defense", pct: 20, durationTurns: 12 },
        { type: "wireOnly" },
      ],
    ],
    drills: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "defense", pct: 15, durationTurns: 8 },
        { type: "wireOnly" },
      ],
    ],
  ...
  "worldEvents.warScareProtests": {
    ...
    crackdown: [
      [
        ...
        { type: "sectorOutputDemandModifier", sectorType: "defense", pct: 10, durationTurns: 10 },
        { type: "wireOnly" },
      ],
    ],
  },
