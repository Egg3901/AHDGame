...
const RUNTIME: CollectionEntry[] = [
  ...
  },
  {
    ...
    category: "runtime",
    notes:
      "Coverage-backed corp-to-corp advertising agreements (allocation shares of buyer marketing budgets); tied to corporations, which are wiped on reset.",
  },
  {
    name: "advertisingSettlements",
    category: "runtime",
    notes:
      "Per-corporation per-turn advertising settlement attribution (settled/contracted/spot/effective spend); regenerated by turns, wiped on reset.",
  },
  {
    name: "commodityPrice",
    category: "runtime",
