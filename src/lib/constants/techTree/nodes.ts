...
const SECTOR: Partial<Record<CorporationType, Record<string, NodeSpec[]>>> = {
  ...
  media_entertainment: mergeLaneMaps(MEDIA_SECTOR, ENTERTAINMENT_SECTOR, "base"),
  chemical_industries: {
    "1940": [
      {
...
const SECTOR_EXTRA: Partial<Record<CorporationType, Record<string, NodeSpec[]>>> = {
  ...
  media_entertainment: mergeLaneMaps(MEDIA_SECTOR_EXTRA, ENTERTAINMENT_SECTOR_EXTRA, "extra"),
  chemical_industries: {
    "1979": [
      {
...
const SECTOR_EXTRA2: Partial<Record<CorporationType, Record<string, NodeSpec[]>>> = {
  ...
  media_entertainment: mergeLaneMaps(MEDIA_SECTOR_EXTRA2, ENTERTAINMENT_SECTOR_EXTRA2, "extra2"),
  chemical_industries: {
    "1979": [
      {
