...
import {
  ECON_COUNTRY_CABINET_MECHANICS,
  ECON_COUNTRY_CABINET_POSITIONS,
} from "./econCountryCabinet";
...
const MECHANICS_BY_COUNTRY: Record<string, Record<string, CabinetPositionMechanics>> = {
  ...
  FR: ECON_COUNTRY_CABINET_MECHANICS,
  IT: ECON_COUNTRY_CABINET_MECHANICS,
  ES: ECON_COUNTRY_CABINET_MECHANICS,
  SE: ECON_COUNTRY_CABINET_MECHANICS,
  TR: ECON_COUNTRY_CABINET_MECHANICS,
  AT: ECON_COUNTRY_CABINET_MECHANICS,
  FI: ECON_COUNTRY_CABINET_MECHANICS,
  GR: ECON_COUNTRY_CABINET_MECHANICS,
  BR: ECON_COUNTRY_CABINET_MECHANICS,
};
...
const POSITIONS_BY_COUNTRY: Record<string, ReadonlyArray<CabinetPositionDef>> = {
  ...
  FR: ECON_COUNTRY_CABINET_POSITIONS,
  IT: ECON_COUNTRY_CABINET_POSITIONS,
  ES: ECON_COUNTRY_CABINET_POSITIONS,
  SE: ECON_COUNTRY_CABINET_POSITIONS,
  TR: ECON_COUNTRY_CABINET_POSITIONS,
  AT: ECON_COUNTRY_CABINET_POSITIONS,
  FI: ECON_COUNTRY_CABINET_POSITIONS,
  GR: ECON_COUNTRY_CABINET_POSITIONS,
  BR: ECON_COUNTRY_CABINET_POSITIONS,
};
