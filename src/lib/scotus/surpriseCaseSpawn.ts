 ...
 * to occasionally surface flavor content over a multi-decade playthrough,
 * not compete with curated historical content for attention (#3607's
 * "rarer... than authored Docket cases by default" guidance).
 *
 * At 0.004/turn, a fully-seated Court averages roughly one surprise case every
 * ~250 turns (~5.2 years at TURNS_PER_YEAR = 48), rare enough to read as a genuine surprise, frequent
