/**
 * Forwarder. Moved into TR's country folder.
 *
 ...
 */
export * from "@/lib/countries/tr/data/trDemographicCategories";
export { default } from "@/lib/countries/tr/data/trDemographicCategories";
