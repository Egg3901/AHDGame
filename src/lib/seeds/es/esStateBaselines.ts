...
import { esStateMetrics } from "./esStateMetrics";

/** Spain region metric baselines — derived 1:1 from esStateMetrics. */
...
export const esStateBaselines: StateMetricBaseline[] = esStateMetrics.map(toBaseline);
