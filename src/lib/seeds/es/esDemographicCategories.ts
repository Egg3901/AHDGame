/**
 * Forwarder. Moved into ES's country folder.
 *
 ...
 */
export * from "@/lib/countries/es/data/esDemographicCategories";
export { default } from "@/lib/countries/es/data/esDemographicCategories";
