...
describe("IE 2023 calibration — Ireland 2020 Dáil election anchor (SF consolidation, rural backlash)", () => {
  const leans = deriveRegionLeans("IE", "2023");
  ...
  it("calibration cell reports zero loss", () => {
    const cell = evaluateCell("IE", "2023");
