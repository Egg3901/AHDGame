/**
 * Forwarder. Moved into FI's country folder.
 *
 ...
 */
export * from "@/lib/countries/fi/data/fiDemographicCategories";
export { default } from "@/lib/countries/fi/data/fiDemographicCategories";
