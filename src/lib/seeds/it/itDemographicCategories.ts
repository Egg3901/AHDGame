/**
 * Forwarder. Moved into IT's country folder.
 *
 ...
 */
export * from "@/lib/countries/it/data/itDemographicCategories";
export { default } from "@/lib/countries/it/data/itDemographicCategories";
