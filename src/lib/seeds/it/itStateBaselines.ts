...
import { itStateMetrics } from "./itStateMetrics";

/** Italy region metric baselines — derived 1:1 from itStateMetrics. */
...
export const itStateBaselines: StateMetricBaseline[] = itStateMetrics.map(toBaseline);
