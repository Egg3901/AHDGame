...
import { seStateMetrics } from "./seStateMetrics";

/** Sweden region metric baselines — derived 1:1 from seStateMetrics. */
...
export const seStateBaselines: StateMetricBaseline[] = seStateMetrics.map(toBaseline);
