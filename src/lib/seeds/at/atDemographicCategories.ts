/**
 * Forwarder. Moved into AT's country folder.
 *
 ...
 */
export * from "@/lib/countries/at/data/atDemographicCategories";
export { default } from "@/lib/countries/at/data/atDemographicCategories";
