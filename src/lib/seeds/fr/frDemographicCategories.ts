/**
 * Forwarder. Moved into FR's country folder.
 *
 ...
 */
export * from "@/lib/countries/fr/data/frDemographicCategories";
export { default } from "@/lib/countries/fr/data/frDemographicCategories";
