 ...
 * another era's seed data (e.g. the 2019 `sectorSeedWeights` array). Values are
 * projected independently for January 2027 from the latest measured sector mix. Same-era imports (states2023 for region IDs) and type-only
 * imports are allowed.
 */
 ...
 * 2023 data is authored. `getCountrySectorWeights2027` returns an even
