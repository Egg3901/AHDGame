...
- **Cheapest up front, costliest over time:** The −2% GDP hit is attractive, but 20-30% income capture plus a 15% share discount can cost more than a one-time restructuring if the facility runs for many turns.
