...
Two start dates are available when an admin resets the world: **1991** and **2019**. Use the toggle at the top of the dashboard to switch between them. Both are canonical openings with full economy/party/region/historical-seat coverage across seven countries: US, UK, Japan, Germany, China, Brazil, and Ireland.
