export const advancedStrategyContent = `# Advanced Strategy
...
Every election you enter has an opportunity cost: actions spent campaigning cannot build Political Influence elsewhere, and the office you win locks in your home state for future races. Map your arc 2 to 3 game years (96 to 144 turns) ahead:
...
Legislation influences state-level metrics (healthcare, economy, education, environment), which feed into demographic favorability. Passing a popular bill 4 to 8 turns before a general election in your home state is not a coincidence; it's a tactic.
...
- [Reference: Offices](/wiki/reference-offices): Complete office stats and action bonuses.
- [Primaries](/wiki/primaries): Declaration rules, score formula.
- [Campaign Strategy](/wiki/campaign-strategy): Phase-by-phase action allocation.
- [Reading the Game](/wiki/reading-the-game): How to use available data to inform decisions.
`;
