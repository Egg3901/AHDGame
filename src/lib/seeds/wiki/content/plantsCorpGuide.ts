...
Share is the slice of what producers in that market currently earn, one industry in one place. If you are the only corporation selling there, the pie reads 100%, even while you still have capacity under construction. That is not a cap on demand and it does not mean extra plants will go unsold. The pie names this "of producers." Check the note under the pie, or the build dialog, for how much room buyers still have; extra output beyond that sells only if you take volume from a rival or demand grows.
