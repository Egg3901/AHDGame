export const primaryGeneralTacticsContent = `# Primary vs General Tactics
...
For phase rules see [Primaries](/wiki/primaries) and [General Elections](/wiki/general-elections). For tactical depth see [Campaign Strategy](/wiki/campaign-strategy).
...
Primary is the cheap phase for campaign-page upgrades. Every ₳1 spent here is ₳1; in general it's ₳0.67 of value per dollar (1.5x cost).
...
Primary: no Opposition Research (you're all in the same party).
General: pick the leading opponent. Retarget as the race progresses if someone else becomes the threat.

### Campaign intensity

Primary: moderate. You're winning on alignment and Favorability, PI matters less than you'd think past ~40.
General: ramp. PI matters heavily in the state race reach x appeal x approval x party-org formula. Push PI to 70-80 for the closing sprint.
...
General: **selective attacks**: if an opponent's Favorability is 65-75 and you can drop them 5-10 points with 5-10 attack actions, that's often race-winning value. Against 80+ Favorability opponents the diminishing returns protect them. Against under-50 opponents, they're already losing, don't waste Infamy.
...
## Pivoting checklist (primary win to general)
...
- [ ] Commission Full Demographic Poll: general voters are not the same as primary voters.
- [ ] Check campaign upgrade levels: are they sufficient? Last cheap opportunity to upgrade was the primary phase; you're now in 1.5x-cost territory.
...
- [Election Mechanics](/wiki/election-mechanics): core framework.
- [Primaries](/wiki/primaries): primary-phase rules.
- [General Elections](/wiki/general-elections): general-phase rules.
