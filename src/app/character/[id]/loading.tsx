...
// The character profile renders the same header + 3-column layout as /profile
// (its own segment) but runs ~30 Mongo queries server-side before returning any
// bytes. Without a skeleton, App Router shows a blank page for the whole SSR
// wait; this mirrors profile/loading.tsx so navigation feels instant.
