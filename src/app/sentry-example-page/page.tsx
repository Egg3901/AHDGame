      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://ahousedivided.sentry.io/issues/?project=4511033314836480"
          >
            Issues Page
          </a>
          . For slow routes and transactions (last 7 days), open{" "}
          <a
            target="_blank"
            rel="noopener"
            href="https://ahousedivided.sentry.io/explore/traces/?query=project%3Aa-house-divided+is_transaction%3Atrue&statsPeriod=7d&mode=aggregate"
          >
            Traces
          </a>
