    ...
    <div className="mb-6 rounded-lg border border-warning/20 bg-warning/5 px-3 py-2">
      ...
      <details className="group mt-1.5 pl-5">
        ...
        <p className="mt-1.5 text-[11px] leading-relaxed text-muted/80">
          {isUSPresidential
            ? "Primary share = candidate score ÷ total in that party. Pre-stagger projections use policy alignment (40) + favorability (25) + party influence (20) + national influence (15). Once the final 6 turns begin, awarded delegates stay locked while uncalled states keep projecting forward. Your own Campaign Presence (built on this page) multiplies vote weight in that state (about +19% at level 10, approaching +25% with further investment), separate from party-wide org."
