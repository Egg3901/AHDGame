...
// POST /api/discord-bot/supporter/remove — Remove supporter status from a player.
// Body: { discordId?: string, name?: string }
...
export async function POST(request: Request) {
  try {
    ...
    await createAdminLog({
      ...
      details: `Cleared supporter status via /supporter remove command.`,
    });
