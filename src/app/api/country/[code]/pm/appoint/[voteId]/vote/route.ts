// POST /api/country/[code]/pm/appoint/[voteId]/vote — Cast an aye/nay vote on a PM appointment
...
import { castPmAppointmentVote } from "@/lib/government/commands/parliamentaryGovernment";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      await castPmAppointmentVote(db, countryId, auth.user.character, voteId, parsed.data.vote)
    );
  } catch (error) {
