...
function makeRequest() {
  return new Request("http://localhost/api/country/us/region/CA/party/1/suppression", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ suppressionBudgetPercent: 10 }),
  });
}

describe("POST suppression cross-country guard", () => {
  let db: MockDb;
