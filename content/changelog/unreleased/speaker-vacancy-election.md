...
- A leadership chair emptied because its holder no longer sits in the chamber now opens an election to refill it. Previously the seat was vacated and nothing else happened, so the chair read "Vacant" indefinitely. This is what left the House with no Speaker after a general election.
